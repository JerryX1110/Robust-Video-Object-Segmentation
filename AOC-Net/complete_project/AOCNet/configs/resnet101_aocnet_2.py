...
class Configuration():
    def __init__(self):
        ...
        self.DIR_TEMP_RESULT = '/datasets/result_evaluation/'
        self.DIR_DAVIS =  os.path.join(self.DIR_DATA, 'DAVIS')
        self.DIR_PORTRAIT_DATA ='/datasets/Portrait_dataset/dataset_post/'
        self.DIR_YTB =  os.path.join(self.DIR_DATA, 'train_all_frames/train_all_frames/')
        self.DIR_YTB_EVAL =  os.path.join(self.DIR_DATA, 'valid_all_frames/valid_all_frames/')
        ...
        self.PRETRAIN_MODEL = '/datasets/MODELS/CFBI/resnet101-deeplabv3p.pth.tar'

        self.MODEL_BACKBONE = 'resnet'
        self.MODEL_MODULE = 'networks.aoc.aocnet'
