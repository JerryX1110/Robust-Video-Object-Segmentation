...
sys.path.append('.')
sys.path.append('..')
from networks.engine.eval_manager_mm_rpa import Evaluator
import importlib
...
def main():
    ...
    parser.add_argument('--config', type=str, default='configs.resnet101')
    ...
    parser.add_argument('--ucr', type=float, default=1.0)
